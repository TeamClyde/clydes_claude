...
description: Use when starting feature work that needs isolation from current workspace or before executing implementation plans - creates isolated git worktrees with smart directory selection and safety verification. Owns workspace isolation before work starts; `finishing-a-development-branch` is the cleanup pair.
