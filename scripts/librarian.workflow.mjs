...
// schema and enforced by the guard, not by validation — a required field here would reject the reframe
// path, which still runs the single-agent shape and produces no excerpt. It stays load-bearing for
// excerptGuard and Tier 2 verify regardless; see the schema pin in librarian.workflow.test.mjs.
